...
const NavBar = () => {
  return (
    <nav className="navbar navbar-expand-lg bgval fixed-top hover-nav">
    <div className="container">
      <span className="navbar-brand" href="#"><img src="https://getbootstrap.com/docs/5.2/assets/brand/bootstrap-logo.svg" alt="" width="34" height="28" className="d-inline-block align-text-top" />
