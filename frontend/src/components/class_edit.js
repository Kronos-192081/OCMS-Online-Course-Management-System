        ...
        if(class_id !== "1")
        {
            ...
            .then((res) => {
                ...
                if(res.ok)
                {
                    ...
                    history.push('/classlist_admin/' + id);
                }
            })
        }
        else
      ...
      <div className="login">
          <div className="row">
            ...
            <div className="col-md-12 m-auto">
              <br />
              <h5 className="lead text-center" style ={{fontWeight: "bold"}}>{(class_id==="1")?"Create Class":"Edit Class"}</h5>
              <br />
              <form onSubmit={handleSubmit}>
                ...
                />
                <br />
                { !isPendingUpdate && <button>{(class_id==="1")?"Create Class":"Edit Class"}</button> }
