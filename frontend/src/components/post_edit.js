      ...
      <div className="login">
          <div className="row">
            ...
            <div className="col-md-12 m-auto">
              <br />
              <h5 className="lead text-center" style ={{fontWeight: "bold"}}>{(id==="1")?"Create Post":"Edit Post"}</h5>
              <br />
              <form onSubmit={handleSubmit}>
                ...
                />
                <br />
                { !isPendingUpdate && <button>{(id==="1")?"Create Post":"Edit Post"}</button> }
